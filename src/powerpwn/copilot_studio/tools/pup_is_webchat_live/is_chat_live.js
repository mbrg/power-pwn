...
(async () => {
    ...
    try {
        ...
        if (allStringsAbsent) {
            ...
            await fs.appendFile('../../final_results/chat_exists_output.txt', targetPageUrl + '\n');
        } else {
        ...
        if (e.name === 'TimeoutError') {
            ...
            process.stdout.write(chalk.orange("Error occurred while trying to find chat texts:", e));
        }
    }
