...
(async () => {
  ...
  try {
    ...
    console.log('Waiting for chatbot input box...');
    await page.waitForSelector(inputBoxSelector, { timeout });
    console.log('Chatbot input box found.');
    ...
    console.log('Initial bot message count:', initialBotMessageCount);
    ...
    console.log('Waiting for the chatbot responses...');
    ...
    console.log('Extracting third chatbot response...');
